...
class _JoinGamePageState extends State<JoinGamePage> {
  ...
  Future<void> _joinRoom() async {
    ...
    try {
      ...
      AppLogger.i("Attempting to join room: $roomCode with player name: $playerName");
      ...
      if (success && mounted) {
        ...
        setState(() {
          _errorMessage = roomProvider.error ?? "Failed to join room. Please try again.";
        });
      }
    } catch (e) {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 16),
                    Text(
                      "Enter the room code and your player name to join an active game.",
                    ...
                    TextFormField(
                      ...
                      onChanged: (value) {
                        ...
                        if (value.length == 4 && !value.contains('-')) {
                          _roomCodeController.text = '${value.substring(0, 3)}-${value.substring(3)}';
